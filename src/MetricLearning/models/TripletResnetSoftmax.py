...
def TripletResnet50Softmax(pretrained=False,  num_classes=50, embedding_size=128, img_type="RGB"):
    model = Triplet_ResNet_Softmax(Bottleneck, [3, 4, 6, 3], num_classes=num_classes)
    ...
    # Modify some of the last layers
